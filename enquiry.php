...
<div class="container">
<div class="main">
	<h2 class="text-center form-heading"><i class="fa fa-question-circle" style="color:#00405d;"></i> Have a query!</h2>
	<!-- start registration -->
	<div class="registration container" style="padding:30px 0px">
		...
		<input type="hidden" value="enquiry" name="form_type"></input>
