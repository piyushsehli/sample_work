...
<div class="main">
	...
	<h2 class="text-center form-heading"><i class="fa fa-pie-chart" style="color:#00405d;"></i> Give your feedback!</h2>
	...
	<div class="registration container" style="padding:30px 0px">
		...
		<input type="hidden" value="feedback" name="form_type"></input>
		<!-- [if IE] 
